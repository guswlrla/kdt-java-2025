...
class Order {
	...
	// 생성자 작성
	public Order(Customer c1, int size) {
...
public class 실습_7_1_객체생성 {
	public static void main(String[] args) {
		...
		// 고객 생성
		Customer c1 = new Customer("홍길동", "부산", 21);
		Customer c2 = new Customer("계백", "양산", 22);
		
		// 주문 생성
		Order order1 = new Order(c1, 5); // 최대 5개 아이템
		...
		Order order2 = new Order(c2, 5); // 최대 5개 아이템
