...
abstract class Employee extends Object {
	...
	@Override // object에 있는걸 오버라이드
	public String toString() { // 이걸 안하면 object에 있는 toString이 실행됨
...
//	}
	...
	public static void calcTax(Employee e) {
		// 바인딩: 실행시간에 메소드 이름에 해당하는 메소드 바디를 결정
		e.calcSalary(); // 동적 바인딩 - Employee e = new Salesman();과 같음
...
//			System.out.println(e.managingNo );//오류
	...
	public static void main(String[] args) {
		...
		c.calcBonus();
		d.calcBonus();
		calcTax(s); //파라미터 전달 (static이니까 호출)
		calcTax(c);
		calcTax(d);
		/*
		...
		Object arr[] = new Object[6]; // new 쓴다해서 객체 만드는게 아니라, 배열만 만듦 (아직 객체 안만들었음)
		arr[0] = s1;arr[1] = s3;arr[2] = s4;
		arr[3] = m1;arr[4] = m2;arr[5] = m3;
		
		for (Object o : arr) // 확장형 for문
			System.out.println(o.toString()); // 동적 바인딩 - 객체들의 배열을 사용할 때 동적바인딩으로
