...
interface Messenger {
	...
	// 바디를 갖는 함수를 가지려면 default를 붙여야 함
...
class GalaxyMessenger2 implements Messenger, WorkFile { // 2개 내려받는 건 class는 안됨, interface만 가능
	public String getMessage() {
		return "galaxy";
	}
	public void setMessage(String msg) {
...
class GalaxyMessenger3 extends Visualize implements Messenger, WorkFile { // 이렇게도 가능
	public String getMessage() {
		return "galaxy";
	}
	public void setMessage(String msg) {
