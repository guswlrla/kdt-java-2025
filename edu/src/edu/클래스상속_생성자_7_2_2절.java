...
//	}
//
//	public Employee(String name, int age, String dept) { // 객체를 만들면서 상속받았기 때문에 emp객체엔 name, age, dept 인스턴스가 다 있음
//		// this.name = name; // 에러
//		// this.name = name;
//		// super.setName(name);
//		// super.setAge(age);
...
//		// name = name;
//		// this.name = name;
//		// super.setName(name); // 중복코딩
//		// super.setAge(age); // 중복코딩
//		super(name, age); // 중복코딩을 해소하는 방법
//		this.subject = subject; // 자기꺼
