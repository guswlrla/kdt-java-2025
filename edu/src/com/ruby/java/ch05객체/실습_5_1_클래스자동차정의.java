...
class Car {
	...
	//D-세그먼트(중형차,패밀리 세단 ) > 4,600mm ~ 4,900mm > 약 1,800mm ~ 1,850mm > 현대 쏘나타,기아 K5,BMW 3 시리즈,벤츠 C클래스 
	//E-세그먼트(대형차,고급 세단) > 4,900mm ~ 5,100mm > 약 1,850mm ~ 1,900mm > 현대 그랜저,기아 K8,BMW 5 시리즈,벤츠 E클래스 
	//F-세그먼트(초대형차,플래그십 세단) > 5,100mm 이상 > 1,900mm 이상 > 제네시스 G90,벤츠 S클래스,BMW 7 시리즈,아우디 A8
