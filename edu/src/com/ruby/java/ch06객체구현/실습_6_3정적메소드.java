...
//
//	// 학생 수를 반환하는 정적 메소드 getNumberStudents()
//	public static int getNumberStudents(Student[] students) {
...
//		 */
//		for(int i = 0; i <= 1; i++) {
//			System.out.println("이름 = " + students[i] + "나이 = " + );
//		}
//		System.out.println();
//		
//	}
...
//			s.printStudent();
//			System.out.println("-".repeat(25)); // repeat가 뭐지
//		}
//		
//	}
//}
