...
package com.ruby.java.ch11예외처리;
...
public class Test04_실습대상 {
	...
	public static void b() throws Exception { // throws Exception이 있으면 try catch로 잡아줘야함
		try {
			c();
			c();
	...
	public static void main(String[] args) {
		...
		*/
			try { 
				FileInputStream fi = new FileInputStream("a.txt"); // 에러 발생 이유 - FileInputStream(예외를 던지는 클래스)는 예외처리를 꼭 해야함
				int c = fi.read();
				System.out.println((char) c);
